...
const meatOptions = [
  ...
  { name: 'หมูป่า' }, { name: 'หมูสับ' }, { name: 'เนื้อสับ' }, { name: 'กุ้งแห้ง' }, { name: 'เส้นใหญ่' }, { name: 'ไข่' }
]

const veggieOptions = [
  { name: 'ผักกาด' }, { name: 'แครอท' }, { name: 'บร็อคโคลี่' }, { name: 'เห็ด' }, { name: 'ฟักทอง' },
  { name: 'บวบ' }, { name: 'ถั่วฝักยาว' }, { name: 'ผักบุ้ง' }, { name: 'มะเขือ' }, { name: 'หน่อไม้' },
  ...
  { name: 'หอมใหญ่' }, { name: 'ขมิ้น' }, { name: 'พริกหยวก' }, { name: 'โป๋ยกัํก' },{ name: 'คะน้า' }, { name: 'ผักชี' }
]
